    ...
    <el-header class="navbar">
      <nav>
        ...
        <el-menu mode="horizontal" class="menu" router>
          ...
          <!-- 学生移动端作为下载链接 -->
          <el-menu-item>
            <a href="https://greet-freshman.oss-cn-shanghai.aliyuncs.com/default-avatar.png" download style="color: white; text-decoration: none;">
              学生移动端
            </a>
          </el-menu-item>
        </el-menu>
...
.el-button {
  ...
  color: rgba(255, 255, 255, 0.9); /* 默认字体颜色，稍微降低透明度以提高对比度 */
  border: none; /* 移除边框 */
...
.el-button:hover {
  background-color: rgba(0, 0, 0, 0.1); /* 悬停时背景变为浅黑色，增强对比度 */
  color: #007bff; /* 悬停时字体颜色变为蓝色 */
...
/* 菜单项样式 */
.el-menu-item {
  color: rgba(255, 255, 255, 0.9); /* 提高字体对比度 */
  padding: 0 20px;
  font-weight: bold;
...
.el-menu-item:hover {
  ...
  color: #ffeb3b; /* 悬停时文字颜色变为亮黄色 */
}

/* 链接样式 */
a {
  color: rgba(255, 255, 255, 0.9); /* 提高链接字体对比度 */
  text-decoration: none;
  transition: color 0.3s;
}

a:hover {
  color: #ffeb3b; /* 链接悬停时颜色变亮 */
}
...
.home-page {
  padding-top: 64px; /* 为内容添加顶部间距，避免被固定导航栏遮挡 */
}
</style>